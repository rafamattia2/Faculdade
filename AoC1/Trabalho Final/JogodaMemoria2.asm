...
.text
main:
	add $t2, $zero, 3      # Numero de rodadas MAXIMAS, modifique aqui o numero de rodadas maximas (modifique também o tamanho do ARRAY)
...
loopRodada:		# Insersao e checagem de valores inseridos com os valores do vetor
	...
	lw  $t4, array($t5)
	add $t5, $t5, 4
	bne $s0, $t4, errou # Checagem do numero inserido com o numero gerado
	add $t6, $t6, 1
